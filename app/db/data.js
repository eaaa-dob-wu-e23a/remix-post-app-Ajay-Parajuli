...
import db from "./db-connect.server";
...
// insert users
const maria = await db.collection("users").insertOne({
  image:
...
const rasmus = await db.collection("users").insertOne({
...
const anne = await db.collection("users").insertOne({
  image:
...
const line = await db.collection("users").insertOne({
...
const dan = await db.collection("users").insertOne({
